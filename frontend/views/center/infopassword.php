...
<body>
	...
	<div id="body_h">
		...
		<section class="modular8">
			<form action="" method="post">
				...
				<div class="oneelement borall">
					<input class="changeelement" type="password" name="password" placeholder="输入当前要修改的密码" value="">
				</div>
		...
		<br /><p style="font-size:12px;color:#666;">*修改密码需要重新登录</p>
		</section>
	</div>
