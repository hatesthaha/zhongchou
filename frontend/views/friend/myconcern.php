...
<body>
	...
	<div id="body_h" class="bgeee">
		<section class="pagetop">
			...
			<h2>我的关注</h2>
			<a class="pagetopright" href="/friend/addfriends"><img src="<?= Yii::getAlias('@web') . '/' ?>style/images/usetop.png" alt="我的"></a>
		</section>
		...
		<section class="modular21 modular22">
			<ul>
				<?php 
				if(!empty($myc)){
				foreach($myc as $_k => $vo) : ?>
				<?php
					$friend = Member::find()->where(['id' => $vo['friends_id']])->one();
				?>
				<li>
