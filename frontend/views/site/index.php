...
$dependency2 = [
    'class' => 'yii\caching\DbDependency',
    'sql' => 'SELECT MAX(`product`.`updated_at`),MAX(`product`.`shenhe_at`),MAX(`product`.`end_time`),MAX(`product`.`xiugaitime`),MAX(`money`.`updated_at`) FROM product,money',//
];
...
<!-- 			<a class="pagetopleft" href="javascript:history.go(-1)"><i class='icon-angle-left'></i></a> -->
		...
		<?php
			...
			if($this->beginCache('shoyezhuce', ['duration' => 3600 , 'dependency' => $dependency3])){ 
				//注册人数
		...
		<section class="modular3">
			<ul class="clearfix">
				<li class="modular3-li1">
					<a href="<?= Url::to(['project/buyshengwang'])?>">
